...
class Oferta
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Grupon\CiudadBundle\Entity\Ciudad")
     */
    private $ciudad;
     ...
     * @var string
     *
     * @ORM\ManyToOne(targetEntity="Grupon\TiendaBundle\Entity\Tienda")
     */
    private $tienda;
     ...
     * Set ciudad
     *
     * @param \Grupon\CiudadBundle\Entity\Ciudad $ciudad
     * @return Oferta
     */
    public function setCiudad(\Grupon\CiudadBundle\Entity\Ciudad $ciudad = null)
    {
        $this->ciudad = $ciudad;
     ...
     * Get ciudad
     *
     * @return \Grupon\CiudadBundle\Entity\Ciudad 
     */
     ...
     * Set tienda
     *
     * @param \Grupon\TiendaBundle\Entity\Tienda $tienda
     * @return Oferta
     */
    public function setTienda(\Grupon\TiendaBundle\Entity\Tienda $tienda = null)
    {
        $this->tienda = $tienda;
     ...
     * Get tienda
     *
     * @return \Grupon\TiendaBundle\Entity\Tienda 
     */
